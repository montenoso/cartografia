...
require_once("conecta.php");
              ...
              $sql = "SELECT material_id, selectedradio, titulo_registro, nombre_archivo  FROM documento where selectedradio='foto' ORDER BY fecha_inser DESC LIMIT 5";
              ...
              while ($resultado = mysql_fetch_assoc($datos)) {
                ...
                echo '<div class="titulo" style="margin-top:-5px;">'.$resultado['titulo_registro'].'</div>';
                ?>
                  </div>
                <?php
              }
