...
<html>
    <head>
     ...
     <!-- <script src="http://www.openlayers.org/api/OpenLayers.js"></script>-->
        ...
        <script src="http://montenoso.net/cartografia/postMap-montes3.js"></script>
            ...
            <!-- Content -->
               ...
               <!-- Logo -->
                <form id="form1" name="form1" method="post" action="http://montenoso.net/cartografia/">
                    ...
                    <div id="texto">  "Mapexa e contribue á construcción do coñecemento sobre os Montes Veciñais en Man Común"</div>
                    </br>
                <!--------------------------- MENÚ ACORDEÓN ------------------------------>
                <div id="accordion">
